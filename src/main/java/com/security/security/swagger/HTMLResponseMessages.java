package com.security.security.swagger;
...
public class HTMLResponseMessages {
    ...
    public static final String HTTP_200_WITHOUT_DATA = "Successful request gets this response code.";
    ...
    public static final String HTTP_403 = "Unsuccessful request responds with this code. Requested resource is not " +
            "authorized";
